...
My research focuses on the intersection of online information access, machine learning / AI, and questions of social justice and emancipation.
...
I previously worked at Microsoft for nearly two decades, first at Bing and then at Microsoft Research.
However, in 2025, I made the decision to [leave Big Tech and the broader for-profit tech industry](https://disjunctionsmag.com/articles/why-leaving-big-tech/) in objection to their devastating impact on society.
<br/><br/>
...
<a href="theme-tot" class="btn" style="background-color:gold; text-decoration:none" onmouseover="this.style.backgroundColor='color-mix(in srgb, #000 20%, gold 80%)'" onmouseout="this.style.backgroundColor='gold'">Tip-of-the-Tongue Known-Item Retrieval</a>
<a href="theme-fairness" class="btn" style="background-color:magenta; text-decoration:none" onmouseover="this.style.backgroundColor='color-mix(in srgb, #000 20%, magenta 80%)'" onmouseout="this.style.backgroundColor='magenta'">Exposure Fairness and Transparency in Information Access</a>
<a href="theme-enterprise-knowledge" class="btn" style="background-color:tomato; text-decoration:none" onmouseover="this.style.backgroundColor='color-mix(in srgb, #000 20%, tomato 80%)'" onmouseout="this.style.backgroundColor='tomato'">Enterprise Knowledge Access</a>
<a href="theme-neural-ir" class="btn" style="background-color:violet; text-decoration:none" onmouseover="this.style.backgroundColor='color-mix(in srgb, #000 20%, violet 80%)'" onmouseout="this.style.backgroundColor='violet'">Neural Information Retrieval</a>
<a href="theme-evaluation" class="btn" style="background-color:orange; text-decoration:none" onmouseover="this.style.backgroundColor='color-mix(in srgb, #000 20%, orange 80%)'" onmouseout="this.style.backgroundColor='orange'">Evaluation and Benchmarking</a>
<a href="theme-query" class="btn" style="background-color:teal; text-decoration:none" onmouseover="this.style.backgroundColor='color-mix(in srgb, #000 20%, teal 80%)'" onmouseout="this.style.backgroundColor='teal'">Query Formulation</a>
<br/><br/>
