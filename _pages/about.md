...
<a href="theme-enterprise-knowledge" class="btn" style="background-color:bronze; text-decoration:none" onmouseover="this.style.backgroundColor='color-mix(in srgb, #000 20%, bronze 80%)'" onmouseout="this.style.backgroundColor='bronze'">Enterprise Knowledge Access</a>
